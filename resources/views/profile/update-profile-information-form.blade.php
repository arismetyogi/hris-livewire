<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="username" type="text" class="block w-full mt-1" wire:model="state.username" required
                     autocomplete="username"/>
            <x-input-error for="username" class="mt-2"/>
        </div>

        <div class="flex gap-x-2 col-span-6 sm:col-span-4">
            <!-- Name -->
            ...
            <div class="col-span-3 sm:col-span-2">
                ...
                <x-input id="last_name" type="text" class="block w-full mt-1" wire:model="state.last_name"
