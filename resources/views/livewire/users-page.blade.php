<div class="overflow-x-auto shadow-md sm:rounded-lg">
    <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div class="flex flex-wrap items-center justify-between py-12 space-y-4 flex-column md:flex-row md:space-y-0">
            <div class="ml-4">
                <button wire:click id="dropdownActionButton" data-dropdown-toggle="dropdownAction"
            ...
            <div class="relative">
                ...
                <input wire:model.live.debounce.350="search" type="text" id="table-search-users"
