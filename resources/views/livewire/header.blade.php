...
<div>
    ...
    <header>
        ...
        <!-- Breadcrumbs -->
        <div
            class="hidden lg:flex items-center flex-wrap sticky top-0 inset-x-0 sm:justify-start sm:flex-nowrap z-0 w-full bg-white border-b text-sm py-2.5 sm:py-4 lg:ps-64 lg:pe-2 dark:bg-gray-800 dark:border-gray-700">
