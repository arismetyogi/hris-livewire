<nav x-data="{ open: false }" class="sticky top-0 border-b z-10 bg-white border-gray-100">
    <!-- Primary Navigation Menu -->
    <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Expand / collapse button -->
                <div class="justify-start hidden pt-3 mt-auto lg:inline-flex 2xl:hidden">
                    <div class="w-12 py-2 pr-3">
                        <button
